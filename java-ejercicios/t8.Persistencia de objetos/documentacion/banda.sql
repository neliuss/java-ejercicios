CREATE DATABASE  IF NOT EXISTS `banda` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `banda`;
...
CREATE TABLE `instrumentos` (
  ...
  KEY `fk_musico_idx` (`idmusico`),
  CONSTRAINT `fk_musico` FOREIGN KEY (`idmusico`) REFERENCES `musicos` (`idmusico`)
...
INSERT INTO `musicos` VALUES (2,'22','22','22');
...
-- Dump completed on 2020-04-15 21:08:12
