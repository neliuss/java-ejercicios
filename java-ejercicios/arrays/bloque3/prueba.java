...
public class prueba { 
    ...
    public static void main(String[] args) {
       ...
       System.out.println ("Dame el tama̱o de la lista");
       ...
       //ahora rellenar
        for (x=0; x < lista.length; x++) {   //el length me da el n̼mero de elementos 
     ...
     //rellenar_lista(lista); 
      ...
      //incializar:  
       ...
       int array[][] = { {1,2,3,4}, {5,6,7,8}}; //de esta forma no hace falta indicar tama̱o
      ...
      //Ahora una matriz: 
        ...
        matriz = new int[4][4];
         ...
         for (x=0; x < matriz.length; x++) {   //el length me da el n̼mero de elementos 
    ...
    {
      int x;
    for (x=0; x < list.length; x++) {   //el length me da el n̼mero de elementos 
